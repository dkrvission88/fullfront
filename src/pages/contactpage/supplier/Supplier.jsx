...
import { registerS } from '../../../REDUX/Actions/action1';
...
const handleSubmit=(e)=>{
  ...
  dispatch(registerS(name,phone,serviced,address,city,states,password))
          ...
          <form className="bwell3" onSubmit={(e) =>handleSubmit}>
            ...
            <div className='info-supplyl3'>
                ...
                <div className="bhrl3">
                  ...
                  <div className="honeservl3">
                    ...
                    <div className="pn2l3"  >
                      ...
                      <input id='mmr2' type="text" onClick={service1}  onChange={(e)=>setServiced(e.target.value)} placeholder='Enter Service you provide'
              ...
              <div className="Adrpn3l3">
                <div>Addreess</div>
                <input id='' type="text" placeholder='' value={address} onChange={(e)=>setAddress(e.target.value)} />
              ...
              <div className="city-Statel3">
                <div className="pn4l3">
                  <div>City</div>
                  <input id='' type="text" placeholder='' value={city} onChange={(e)=>setCity(e.target.value)} />
                </div>

                <div className="pn5l3">
                  <div>State</div>
                  <input id='' type="text" placeholder='' value={states} onChange={(e)=>setStates(e.target.value)} />
                </div>
